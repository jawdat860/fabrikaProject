  ...
  return (
    <>
      ...
      <div className="genn-CustomCabinet-TextContainer">
        <div className="genn-CustomCabinet-TextContainer-title">
          {title}
        </div>
        <div className="genn-CustomCabinet-TextContainer-des" dangerouslySetInnerHTML={{ __html: description }}>
         
        </div>
        <div className="genn-CustomCabinet-TextContainer-buttonDes">
          <button className="genn-CustomCabinet-TextContainer-button genn-Baner-button-v1">
